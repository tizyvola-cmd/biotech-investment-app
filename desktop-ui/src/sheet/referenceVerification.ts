...
/** Resolve sponsor trust from stored field or CT.gov lead_sponsor in meta. */
...
/** Study row visible in feed — Exact/Partial sponsor only (blocks cross-ticker NCT noise). */
